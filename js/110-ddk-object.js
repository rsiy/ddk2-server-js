...
DDK.controlOptions = function (id) {
	return {
		...
		data: {
			...
			label: "Data",
			options: {
				initWidget: { id: "s_" + id + "_iw", label: "Options Widget" },
				keywords: { id: "s_" + id + "_keywords", label: "Keywords" },
				queryWidget: { id: "s_" + id + "_qw", label: "Query Widget" },
				queryHeaderWidget: { id: "s_" + id + "_qhw", label: "Query Header Widget" },
				datasource: { id: "s_" + id + "_d", label: "db.amdb" },
				datasourceShared: { id: "s_" + id + "_dse", label: "Shared Datasource Enabled" },
				queryDim: { id: "s_" + id + "_qd", label: "Query Dimension" },
				queryDimList: { id: "s_" + id + "_qdl", label: "Query Dimension List" },
				queryDimOrder: { id: "s_" + id + "_qdo", label: "Query Dimension Order" },
				queryOrder: { id: "s_" + id + "_qo", label: "Query Order" },
				queryTop: { id: "s_" + id + "_qt", label: "Query Top" },
				queryNameEscapeChar: { id: "s_" + id + "_qfnec", label: "Query Field Name Escape Character" },
				queryMode: { id: "s_" + id + "_qm", label: "Query Mode" },
				beforeRender: { id: "s_" + id + "_qbr", label: "Before Render Function" },
				url: { id: "s_" + id + "_qu", label: "Datasource URL" },
				exportQueryWidget: { id: "s_" + id + "_eqw", label: "Export Query Widget" },
				exportFilenameCSV: { id: "s_" + id + "_ecf", label: "Export CSV Filename" },
				chooseMetricsDatasource: { id: "s_" + id + "_mcd", label: "Choose Metrics Datasource" },
				chooseMetricsEnabled: { id: "s_" + id + "_mce", label: "Choose Metrics Enabled" },
				chooseMetricsQueryWidget: { id: "s_" + id + "_mcqw", label: "Choose Metrics Query Widget" },
				metricsDynamic: { id: "s_" + id + "_md", label: "Dynamic Metrics" },
				metricsStatic: { id: "s_" + id + "_ms", label: "Static Metrics" },
				metricsFormat: { id: "s_" + id + "_mf", label: "Metrics Format" },
				filter: { id: "s_" + id + "_fiv", label: "Filter" }
			}
		},
		toolbars: {
			id: "toolbars",
			label: "Toolbars",
			options: {
				toolbarEnabled: { id: "s_" + id + "_te", label: "Toolbar Enabled" },
				toolbarDefault: { id: "s_" + id + "_td", label: "Toolbar Default" },
				
				configEnabled: { id: "s_" + id + "_ce", label: "Config Enabled" },
				csvExportEnabled: { id: "s_" + id + "_ece", label: "CSV Export Enabled" },
				favoriteEnabled: { id: "s_" + id + "_fe", label: "Favorites Enabled" },
				filterEnabled: { id: "s_" + id + "_fie", label: "Filter Enabled" },
				filterGlobalEnabled: { id: "s_" + id + "_fge", label: "Global Filter Enabled" },
				headerEnabled: { id: "s_" + id + "_he", label: "Header Enabled" },
				helpEnabled: { id: "s_" + id + "_helpe", label: "Help Enabled" },
				helpWidget: { id: "s_" + id + "_helpw", label: "Custom Help Content Widget" },
				previewEnabled: { id: "s_" + id + "_pe", label: "Preview Enabled" },
				queryTopEnabled: { id: "s_" + id + "_qte", label: "Query Top Enabled" },
				refreshEnabled: { id: "s_" + id + "_re", label: "Refresh Enabled" },
				typeEnabled: { id: "s_" + id + "_tye", label: "Type Enabled" },
				editEnabled: { id: "s_" + id + "_edite", label: "Edit Enabled" },
				expandEnabled: { id: "s_" + id + "_ee", label: "Expand Enabled" },
				
				bottomLeft: { id: "s_" + id + "_tblw", label: "Bottom Left Widget" },
				bottomRight: { id: "s_" + id + "_tbrw", label: "Bottom Right Widget" },
				topLeft: { id: "s_" + id + "_ttlw", label: "Top Left Widget" },
				topRight: { id: "s_" + id + "_ttrw", label: "Top Right Widget" }
			}
		},
		config: {
			id: "control_config",
			label: "Configuration",
			options: {
				"class": { id: "s_" + id + "_c", label: "Class" },
				config: { id: "s_" + id + "_con", label: "Config", dataType: "json" },
				configWidget: { id: "s_" + id + "_cw", label: "Config Widget" },
				controlConfigWidget: { id: "s_" + id + "_ccw", label: "Control Config Widget" },
				controlCSS: { id: "s_" + id + "_cjs", label: "Control JavaScript" },
				controlJS: { id: "s_" + id + "_ccss", label: "Control CSS" },
				mouseover: { id: "s_" + id + "_mouse", label: "Mouseover" },
				nodataWidget: { id: "s_" + id + "_ndw", label: "No-Data Widget" },
				height: { id: "s_" + id + "_h", label: "Height" },
				width: { id: "s_" + id + "_w", label: "Width" }
			}
		},
		chart: {
			id: "chart",
			label: "Chart",
			options: {
				autoRefreshEnabled: { id: "s_" + id + "_are", label: "Auto-Refresh Enabled" },
				dataTableEnabled: { id: "s_" + id + "_de", label: "Data Table Enabled" },
				labelAutoEnabled: { id: "s_" + id + "_lae", label: "Automatic Labels Enabled" },
				labelAxisX: { id: "s_" + id + "_lax", label: "Axis X Label" },
				labelAxisY: { id: "s_" + id + "_lay", label: "Axis Y Label" },
				labelAxisY2: { id: "s_" + id + "_lay2", label: "Axis Y2 Label" },
				stackedLabelY: { id: "s_" + id + "_layse", label: "Stacked Series Labels Enabled, Axis Y" },
				stackedLabelY2: { id: "s_" + id + "_lay2se", label: "Stacked Series Labels Enabled, Axis Y2" },
				legend: { id: "s_" + id + "_lp", label: "Legend Position" },
				seriesConfig: { id: "s_" + id + "_scp", label: "Series Config Position" },
				type: { id: "s_" + id + "_ty", label: "Type" },
				title: { id: "s_" + id + "_ti", label: "Title" },
				templateWidget: { id: "s_" + id + "_tw", label: "Template Widget" }
			},
			series: {
				id: "series",
				label: "Series",
				options: {
					chartArea: { id: "s_" + id + "_sca", label: "Chart Area" },
					color: { id: "s_" + id + "_sc", label: "Color" },
					configWidget: { id: "s_" + id + "_scw", label: "Config Widget" },
					enabled: { id: "s_" + id + "_se", label: "Enabled" },
					mapareaWidget: { id: "s_" + id + "_smw", label: "Map Area Aattributes Widget" },
					pie: { id: "s_" + id + "_sp", label: "Pie" },
					showLabels: { id: "s_" + id + "_sslav", label: "Show Value Labels" },
					formatAxisX: { id: "s_" + id + "_sxf", label: "X Axis Format" },
					formatWidgetAxisX: { id: "s_" + id + "_sxfw", label: "X Axis Format Widget" },
					secondaryAxisY: { id: "s_" + id + "_sys", label: "Secondary Y Axis" }
				},
				type: {
					id: "type",
					label: "Type",
					options: {
						area: { id: "s_" + id + "_sta", label: "Area" },
						bar: { id: "s_" + id + "_stb", label: "Bar" },
						column: { id: "s_" + id + "_stc", label: "Column" },
						line: { id: "s_" + id + "_stl", label: "Line" },
						point: { id: "s_" + id + "_stp", label: "Point" },
						stacked: { id: "s_" + id + "_sts", label: "Stacked" },
						stepLine: { id: "s_" + id + "_stsl", label: "Step Line" }
					}
				}
			}
		},
		tableAndScorecard: {
			id: "table_scorecard",
			label: "Table and Scorecard",
			options: {
				filterMetricsSelect: { id: "s_" + id + "_fms", label: "Select Column Filters" },
				filterMetricsText: { id: "s_" + id + "_fmt", label: "Text Column Filters" },
				headerWidger: { id: "s_" + id + "_hw", label: "Header Widget" },
				footerWidger: { id: "s_" + id + "_fw", label: "Footer Widget" },
				groupingKey: { id: "s_" + id + "_gk", label: "Grouping Key" },
				groupingExpanded: { id: "s_" + id + "_ge", label: "Grouping Expanded" },
				sortEnabled: { id: "s_" + id + "_soe", label: "Sort Enabled" },
				sortValue: { id: "s_" + id + "_sv", label: "Sort Value" }
			}
		},
		paging: {
			id: "paging",
			label: "Paging",
			options: {
				thresholdClient: { id: "s_" + id + "_ptc", label: "Client Threshold" },
				thresholdServer: { id: "s_" + id + "_pts", label: "Server Threshold" },
				type: { id: "s_" + id + "_pt", label: "Type" }
			}
		}
	};
};
